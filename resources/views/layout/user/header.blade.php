...
<div class="container-fluid fixed-top " style="margin-top: 58px; z-index: -1; position: absolute;">
   <nav class="navbar hr  " style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
      ...
      <a class="nav-link" href="{{ route('proshowcate', $id = 4) }}" ></i>   RAM</a>
      <a class="nav-link" href="{{ route('proshowcate', $id = 5) }}" >  Card </a>
      <a class="nav-link" href="{{ route('gioithieu') }}" >   Case  </a>
      <li class="nav-item dropdown">
